...
try:
    ...
    time.sleep(3)
    print("Typing my name...")
    driver.find_element_by_name('Name').send_keys('kishore')
    time.sleep(3)
    print("Typing my Email address...")
    driver.find_element_by_name('Email').send_keys('kishore@gmail.com')
    time.sleep(3)
